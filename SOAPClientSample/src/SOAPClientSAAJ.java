...
public class SOAPClientSAAJ {
	...
	public static void main(String args[]) {
		 ...
		 */
		String soapEndpointUrl = "http://localhost:8080/SOAPServer/services/HelloWorld";
		String soapAction = "";
	...
	private static void createSoapEnvelope(SOAPMessage soapMessage) throws SOAPException {
		...
		String myNamespace = "";
		String myNamespaceURI = "http://service.web.com";
		...
		SOAPElement soapBodyElem = soapBody.addChildElement("subtractValue", myNamespace);
		SOAPElement soapBodyElem1 = soapBodyElem.addChildElement("value", myNamespace);
