/**Gists provided for illustrative purposes only.Developers can use these as a support tool*but the Office of the Revenue Commissioners(Revenue)does not provide any warranty with*these gists.*/
...
public class SOAPClientSample {
	...
	/*
	 * Gists provided for illustrative purposes only. Developers can use these as a
	 * support tool but the Office of the Revenue Commissioners (Revenue) does not
	 * provide any warranty with these gists.
	 * 
	 * In this example we will perform the following steps
	 * 
	 * 1.Read in an XML file and generate a DOM Document object. The input file
	 * should conform to the CoC schema. 2.Wrap the DOM Document in a SOAP Envelope.
	 * 3.Sign the SOAP Envelope. 4.Output the generated SOAP Message to a file.
	...
	/*
	 * Sample request file <rpn:LookupRPNRequest
	 * xmlns:rpn="http://www.ros.ie/schemas/paye-employers/v1/rpn/">
	 * <rpn:EmployerRegistrationNumber>8000384SH</rpn:EmployerRegistrationNumber>
	 * <rpn:SoftwareUsed> <rpn:Name>SOAP UI</rpn:Name> <rpn:Version>1</rpn:Version>
	 * </rpn:SoftwareUsed> <rpn:TaxYear>2019</rpn:TaxYear> </rpn:LookupRPNRequest>
	 */
	...
	private SOAPMessage signSOAPMessage(SOAPMessage soapMessage) throws Exception {
		...
		// (ii) Add Binary Security Token. The base64 encoded value of the ROS digital
		// certificate.
	...
	private SOAPElement addTimestamp(SOAPElement securityElement, SOAPMessage soapMessage) throws SOAPException {
		...
		timestamp.addChildElement("Expires", "wsu").setValue(
				timeStampFormatter.format(ZonedDateTime.now().plusSeconds(30).toInstant().atZone(ZoneId.of("UTC"))));
	...
	private java.security.cert.Certificate getCertificate() throws Exception {
		...
		keystore.load(new FileInputStream(new File("C:\\projects\\certificates\\999963110.p12")),
				passwordHashedbase64.toCharArray());
	...
	private SOAPElement addBinarySecurityToken(SOAPElement securityElement, java.security.cert.Certificate cert)
			throws Exception {
	...
	private SOAPElement addSignature(SOAPElement securityElement, SOAPBody soapBody, SOAPElement timestamp)
			throws Exception {
	...
	private void createDetachedSignature(SOAPElement signatureElement, PrivateKey privateKey,
			SOAPElement securityTokenReference, SOAPBody soapBody, SOAPElement timestamp) throws Exception {
		...
		// Transform
		Transform envTransform = xmlSignatureFactory.newTransform("http://www.w3.org/2001/10/xml-exc-c14n#",
		...
		javax.xml.crypto.dsig.SignatureMethod sm = xmlSignatureFactory
				.newSignatureMethod("http://www.w3.org/2001/04/xmldsig-more#rsa-sha512", null);
		...
		signContext.setIdAttributeNS(timestamp,
				"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd", "Id");

		KeyInfoFactory keyFactory = KeyInfoFactory.getInstance();
		DOMStructure domKeyInfo = new DOMStructure(securityTokenReference);
		javax.xml.crypto.dsig.keyinfo.KeyInfo keyInfo = keyFactory
				.newKeyInfo(java.util.Collections.singletonList(domKeyInfo));
	...
	/*
	 * Sample signed SOAP message The signature value depends on 1) Time when it was
	 * generated. 2) Request file 3) Certificate Therefore, the envelope can be
	 * different from expected. <env:Envelope
	 ...
	 * ValueType=
	 * "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3"
	 * wsu:Id="X509Token">MIIEmDCCA4CgAwIBAgIQWqFOg5Xcex9Y/
	 ...
	 * +iNe197I9iqHMuqsO2OUrH/
	 * RepW9rj9Y0Knz81VgZwA12KLGmr1oxX0oStejk1q19W5oEHt1103H8AhWIp+
	 * ZZx3AQo7TIxD5gRseEIbOu7MNmTL0kjxi4P43Vg3Nr8Jwwdm7BiBIGTTgV6Xnz5BOm7Q5Gqd3B7/
	 * HogTdRYit3XzrzCOExC4c4jzuLixjynTKnrMaZiqO91cbkPCrSjpY9Tol390TC4oti8K+
	 * ODXK9A1UxKeixyDq9CuD7ccAaQNUp7Tkgda5UsCAwEAAaOCAWQwggFgMB8GA1UdIwQYMBaAFKEt5xi09serBBpMDFevig
	 * /M9P/
	 * 
	 * /cJhgTVL4jANBgkqhkiG9w0BAQsFAAOCAQEAEGjWKAnpLDDtXR+G8Wq5KGZ6Nxnehv3nVtc/iEs+
	 * tw5EeChU9beCEmgLF1vV3QFCfil8ta4k0uB8ZFUKIbMhF4JHXTJaMo39e8kq+
	 * UGReAgJxHfw5YGcngwGBLhZV1ut+1HKgbWLCUnji7zOOMSkv2flkmubOqsxIgYrvcSw24d0/o+
	 * pyN9PKgRYRcizbBFjthQX1VzeF32dvprorXUqEQ+3HcbsvIBdSjF7IbwECO6iABir2aKdhCQm+
	 * poVPD6SmOzRoHggrvniAmUKy3czQKKYiG1cyoJZ/6u4o3naTWn/Q/
	 * egZGH9qTLM2eiQzYQ2otViw45HSPtuyUEsfpdBqQ==</wsse:BinarySecurityToken>
	 * <wsu:Timestamp wsu:Id="TS">
	 * <wsu:Created>2018-09-05T13:57:41.449Z</wsu:Created>
	 * <wsu:Expires>2018-09-05T13:58:11.462Z</wsu:Expires> </wsu:Timestamp>
	 * <ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#"> <ds:SignedInfo>
	 * <ds:CanonicalizationMethod
	 * Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/> <ds:SignatureMethod
	 * Algorithm="http://www.w3.org/2001/04/xmldsig-more#rsa-sha512"/> <ds:Reference
	 * URI="#Body"> <ds:Transforms> <ds:Transform
	 * Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/> </ds:Transforms>
	 * <ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha512"/>
	 * <ds:DigestValue>+I/W7eTNgtLlOtxazFh+vjAG+MCUET2+LJ2yu3+
	 * iP4A6yJznTkdQiJ34onWE8SYAoZUYD2MKvsHt Wz++X9wzEA==</ds:DigestValue>
	 * </ds:Reference> <ds:Reference URI="#TS"> <ds:Transforms> <ds:Transform
	 * Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/> </ds:Transforms>
	 * <ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha512"/>
	 * <ds:DigestValue>Jr/9zWaQ0Y7VBQE9OM6HPwzX+AD7tNnAiJFYqRdF0E+b40c9JZt/
	 * f4w0x25v9kKMszAovhgmbEQc 1ZrVzG5d2Q==</ds:DigestValue> </ds:Reference>
	 * </ds:SignedInfo> <ds:SignatureValue>
	 * GPBxhqQ6aBcIQDpphqboZsTJYjbM6FJcnpDckUjNymp4MZZpPpasn1eo0CWKOM3GxqKh1BiNt586
	 * YIPrDne6gkyYtadRiLMKQKFwWpQDvjGTtjfLfi5EHzTyD2OhAH+VswOvsNraLlDC8Ph4qc6rpCu2
	 * HwiRW/vl+8a2v3pyL/c=</ds:SignatureValue> <ds:KeyInfo>
	 ...
	 * </env:Header> <env:Body xmlns:wsu=
	 * "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"
	 * wsu:Id="Body"> <rpn:LookupRPNRequest
	 * xmlns:rpn="http://www.ros.ie/schemas/paye-employers/v1/rpn/">
